...
+============+==========================================================================+
| ISIS       | :doc:`ISIS-OBC <linux-docs/working-with-the-iobc>`                       |
+------------+--------------------------------------------------------------------------+
| Pumpkin    | :doc:`Pumpkin Motherboard Module 2 <linux-docs/working-with-the-mbm2>`   |
+------------+--------------------------------------------------------------------------+
| Beaglebone | :doc:`Beaglebone Black, Rev. C <linux-docs/working-with-the-bbb>`        |
+------------+--------------------------------------------------------------------------+

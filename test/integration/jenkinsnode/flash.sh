...
# A shell script to copy files over a UART connection using the 
# zmodem protocol.
# 
# To use this script, execute it with a command line argument of
# the complete path and filename you want to copy.
# 

${THISFILE} /path/to/file/named/something.txt 
...
then
  echo""
  echo -e "${RED}This script requires at least $MINPARAMS command-line ${PLURAL}!${NC}"
fi
